...
const QuickActionsWrapper = (props: IQuickActionsWrapper) => {
	return (
		<div className="w-1/2 flex flex-col space-y-4">
			...
			<div className="w-full p-2 flex space-x-4">
				<div onClick={() => props.setTab("cash")} className={`p-4 h-32 w-1/2 flex flex-row justify-center items-center space-x-2 hover:-translate-y-4 hover:cursor-pointer transition-all duration-300 ${props.dark ? "border border-brand-font shadow-sm-light-btn" : "border border-brand-black shadow-sm-btn"}`}>
