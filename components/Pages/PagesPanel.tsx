    ...
    return (
        <div className="w-full h-full flex flex-col p-6 overflow-y-scroll">
            <AnimatePresence>
                {creatingPage && (
                    ...
                    >
                        <NewPageModal
                            dark={props.dark}
                            setCC={setCreatingPage}
                            setPages={setPages}
                            setCreatingPage={setCreatingPage}
                        />
                    </motion.div>
                )}
            </AnimatePresence>
            ...
            <div className="w-full h-full flex flex-col space-y-4">
                <h1 className={`font-mt text-5xl font-bold text-brand-black`}>
                    Pages
                </h1>
                <div className="flex space-x-4">
                    ...
                    <h1 className={`font-mt text-xl font-bold text-green-500`}>
                        {liveCount} deployed
                    </h1>
                </div>
                <motion.button
                    ...
                    whileTap={{ scale: 1.1 }}
                    className={`w-44 h-12 rounded-xl font-mt text-lg font-bold border border-brand-black shadow-sm-btn text-brand-black`}
                >
                    New Page
                </motion.button>
                            ...
                            <div className="w-96 h-24 flex bg-brand-soft-white border border-brand-black shadow-sm-btn rounded-xl hover:-translate-y-2 hover:cursor-pointer transition-all duration-300">
                                <div className="w-4/5 flex flex-col">
                                    <div className="flex space-x-2 p-2 items-center">
                                        {page.icon}
                                        <h1 className="font-mt font-bold text-brand-black text-lg">
                                            {page.pageName}
                                        </h1>
                                    </div>
                                    <div className="flex space-x-2 pl-4 items-center">
                                        <h1 className="font-mt font-lg font-medium text-brand-black">
                                            {page.pageType}{' '}
                                        </h1>
                                        <h1 className="font-mt font-lg font-medium text-brand-black">
                                            |
                                        ...
                                        <h1
                                            className={`font-mt font-lg font-medium ${
                                                page.live
                                                    ? 'text-green-500'
                                                    : 'text-brand-black'
                                            }`}
