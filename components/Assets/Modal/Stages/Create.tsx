...
const StageOne = (props: IStageOne) => {
    ...
    return (
        <motion.div
            ...
            className="w-full h-[calc(100%-6rem)] flex flex-col space-y-4 xl:flex-row xl:space-y-0 shrink-0 p-8"
        >
            <div className="w-full xl:w-1/2 h-full flex flex-col space-y-4">
                ...
                <h1 className={`font-mt text-xl text-brand-black`}>
                    You&apos;re close to uploading some creations!
                </h1>
                ...
                <div className="form flex flex-col">
                    ...
                    <input
                        ...
                        onChange={(e) =>
                            props.setAssetGroupName(e.currentTarget.value)
                        }
                ...
                <div className="form flex flex-col">
                    ...
                    <textarea
                        onInput={props.canGoOn}
                        value={props.assetGroupDesc}
                        onChange={(e) =>
                            props.setAssetGroupDesc(e.currentTarget.value)
                        }
            ...
            <div className="w-full xl:w-1/2 flex flex-col space-y-4">
                ...
                <h1 className={`font-mt text-xl text-brand-black`}>
                    Choose an icon to represent this asset group
                </h1>
                ...
                <div className="w-full flex flex-wrap items-center">
                    {emojis.map((emoji) => (
                        <div
                            key={emoji.id}
                            onClick={() => props.setEmojiID(emoji.id)}
