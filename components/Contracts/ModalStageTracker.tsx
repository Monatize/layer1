		...
		<div className="w-full h-24 flex space-x-4 justify-center items-center">
			<div className="w-4/5 flex flex-row space-x-8 justify-center items-center">
                ...
                <div className="flex flex-col space-y-2 justify-center items-center">
					...
					<div className={`font-mt text-xl font-bold ${props.dark ? "text-brand-font" : "text-brand-black"}`}>Customize</div>
				</div>
                ...
                <div className="flex flex-col space-y-2 justify-center items-center">
					...
					<div className={`font-mt text-xl font-bold ${props.dark ? "text-brand-font" : "text-brand-black"}`}>Review</div>
				</div>
			</div>
		</div>
	);
